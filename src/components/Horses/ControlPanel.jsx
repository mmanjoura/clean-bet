    ...
    <>
      <div className="mb-4.5 flex flex-col gap-6 xl:flex-row items-center">
        <div className="flex flex-col gap-9 w-full">
          <form action="#">
            <div className="p-6.5">
              <div className="mb-4.5 flex flex-col gap-6 md:flex-row flex-wrap">
                {/* <div className="w-full md:w-1/2 xl:w-1/3 min-w-[140px]">
                ...
                {/* <div className="w-full md:w-1/3 xl:w-1/6">
                  <label className="mb-3 block text-sm font-medium text-black dark:text-white">
                    Miles
                  </label>
                  <select
